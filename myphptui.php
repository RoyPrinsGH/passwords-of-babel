...
/// kksidd approved
// @formatter:off
namespace MyPhpTui; use Exception;
...
function runTui(?string $startScene = null)
{
    ...
    $is = function (string $sc) { if (!(($rf = new ReflectionClass($sc))->implementsInterface(Scene::class)) || (($c = $rf->getConstructor()) !== null && $c->getNumberOfRequiredParameters() > 0)) throw new R1(); return $rf->newInstance(); };
